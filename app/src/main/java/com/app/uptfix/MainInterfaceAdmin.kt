...
class MainInterfaceAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reportedProblemsListView = reportedProblemView
        reference =
    ...
    fun fetchData(context: Context, dorm: String?) {
        reference.orderByChild("dorm").equalTo(dorm)
            .addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for (i in snapshot.children) {
                        if (i.child("date").getValue().toString().equals(date)) {
                            var name =
    ...
    fun viewProblemDetails(){
            ...
            reportedProblemsListView.setOnItemClickListener {parent, view, position, id ->
                ...
                var currentActivityString=getString(R.string.mainInterfaceAdmin)
                intent.putExtra("fullName", reportedProblemList[position].fullName)
                intent.putExtra("phoneNumber", reportedProblemList[position].phoneNumber)
    ...
    fun createCardLayout(reportedProblemCardList: MutableList<ReportedProblemCard>) {
        ...
        reportedProblemView.adapter = cardAdapter
